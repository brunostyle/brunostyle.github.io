var H=Object.defineProperty;var P=Object.getOwnPropertySymbols;var q=Object.prototype.hasOwnProperty,J=Object.prototype.propertyIsEnumerable;var B=(n,o,r)=>o in n?H(n,o,{enumerable:!0,configurable:!0,writable:!0,value:r}):n[o]=r,w=(n,o)=>{for(var r in o||(o={}))q.call(o,r)&&B(n,r,o[r]);if(P)for(var r of P(o))J.call(o,r)&&B(n,r,o[r]);return n};import{s as t,N as E,j as i,a as e,m as p,O as C,U as j,u as T,S as F,A as W,b as Q,L as K,c as V,d as X,_ as Y,e as Z,f as ee,R as ie,g as l,h as ne,i as te,B as ae}from"./vendor.5c9e64c0.js";const re=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))x(c);new MutationObserver(c=>{for(const s of c)if(s.type==="childList")for(const k of s.addedNodes)k.tagName==="LINK"&&k.rel==="modulepreload"&&x(k)}).observe(document,{childList:!0,subtree:!0});function r(c){const s={};return c.integrity&&(s.integrity=c.integrity),c.referrerpolicy&&(s.referrerPolicy=c.referrerpolicy),c.crossorigin==="use-credentials"?s.credentials="include":c.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function x(c){if(c.ep)return;c.ep=!0;const s=r(c);fetch(c.href,s)}};re();const oe=()=>i(ce,{children:[e(g,{to:"/",children:e("i",{className:"fas fa-home"})}),e(g,{to:"/about",children:e("i",{className:"fas fa-address-card"})}),e(g,{to:"/education",children:e("i",{className:"fas fa-user-graduate"})}),e(g,{to:"/skills",children:e("i",{className:"fas fa-code"})}),e(g,{to:"/portfolio",children:e("i",{className:"fas fa-briefcase"})}),e(g,{to:"/services",children:e("i",{className:"fas fa-laptop-code"})})]}),g=t(E)`
  display: block;
...
`,ce=t.nav`
  ...
  padding-top: 1em;
  margin-bottom: 1em;
`,se={hidden:{opacity:0,x:"-10vw"},visible:{opacity:1,x:0,transition:{type:"spring",stiffness:100}},exit:{opacity:0,x:"10vw",transition:{type:"easeInOut"}}},z=({children:n})=>e(p.div,{variants:se,initial:"hidden",animate:"visible",exit:"exit",children:n});var le="/assets/home.5d041ca5.jpg";const de=t.div`
  width: 90%;
  max-width: 800px;
  margin: 0 auto 3em;
`,he=t.div`
...
`,fe=()=>i(me,{children:[e(oe,{}),e(de,{children:e(C,{})})]}),ue={hidden:{y:"100px",opacity:0},show:{y:"-10px",opacity:1,transition:{duration:3,type:"spring",stiffness:200}}},ge={strokeWidth:"4px",fill:"#0000ff"},N={hidden:{pathLength:0,scale:.5},show:{scale:1,pathLength:1,fill:"none",strokeWidth:"8px",transition:{ease:"easeInOut",type:"spring",stiffness:10}}},be=()=>e(ve,{children:i(p.svg,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 500.09 411.766",variants:ue,style:ge,initial:"hidden",animate:"show",children:[e(p.path,{variants:N,d:"M16.101 262.979C-5.614 230.59-8.09 194.077 26.771 162.824c29.364-26.329 77.65-51.302 137.341-91.185 27.773-18.557 42.995-44.574 55.491-71.594 6.279 47.8-10.817 93.485-107.154 140.471-50.919 24.834-82.238 67.232-96.348 122.463z"}),e(p.path,{variants:N,d:"M74.148 333.229c-33.635-34.602-47.288-71.354-10.592-114.391 8.355-9.803 17.294-18.486 26.985-27.083-8.409 14.957-13.21 32.189-13.21 50.513 0 9.199 1.211 18.127 3.48 26.627-3.483 17.927-4.47 38.654-6.663 64.334zm71.762-188.412c13.146-11.603 27.386-24.958 42.889-41.214 27.904-29.267 44.156-66.675 53.908-100.928 13.337 41.638 7.462 87.167-42.145 137.933a103.369 103.369 0 0 0-19.678-1.893c-12.262 0-24.042 2.16-34.974 6.102z"}),e(p.path,{variants:N,d:"M143.593 411.547c-36.726-23.625-56.713-58.084-41.084-101.723 11.086 12.84 25.267 22.943 41.357 29.137-3.885 23.154-3.891 47.418-.273 72.586zm72.912-266.495c2.903-4 5.833-8.072 8.781-12.216 23.536-33.074 32.539-75.066 34.297-110.639 22.316 37.401 26.925 82.874-9.462 143.188-9.726-8.766-21.109-15.727-33.616-20.333z"}),e(p.path,{variants:N,d:"M165.354 176.129h80.784c13.46 0 23.015 3.606 28.643 10.784 5.66 7.177 7.341 16.067 5.048 26.641-1.929 8.893-6.151 16.525-12.671 22.896-4.365 4.234-10.099 7.598-17.231 10.047 9.453 2.592 15.859 7.072 19.238 13.375 3.34 6.336 3.99 14.283 1.918 23.84-1.693 7.807-4.902 14.809-9.603 21.041-4.732 6.232-10.38 11.135-17.02 14.773-4.094 2.24-9.913 3.887-17.448 4.902-10.016 1.365-16.604 2.064-19.791 2.064h-74.477l32.61-150.363zm30.736 58.99h18.757c6.731 0 11.685-1.26 14.889-3.744 3.181-2.521 5.261-6.125 6.278-10.818.949-4.375.395-7.807-1.708-10.258-2.126-2.484-6.445-3.711-12.979-3.711h-19.05l-6.187 28.531zm-12.809 59.063h22.009c7.445 0 12.982-1.4 16.62-4.238 3.671-2.834 6.027-6.65 7.068-11.447.964-4.445.243-8.016-2.195-10.713-2.44-2.695-7.411-4.061-14.985-4.061h-21.911l-6.606 30.459zm133.238-118.053h56.76l2.072 91.48 41.652-91.48h56.564l-32.609 150.365h-35.24l24.865-114.656-52.204 114.656h-31.891l-2.376-114.656-24.865 114.656h-35.338l32.61-150.365zM164.612 0.0"})]})}),ve=t.div`
  stroke: #0000ff;
  width: 200px;
`,ye={hidden:{opacity:0,scale:0},visible:{opacity:1,scale:1,transition:{type:"ease",delayChildren:.5,staggerChildren:.2}}},xe={hidden:{y:20,opacity:0},visible:{y:0,opacity:1}},y=({children:n})=>e(p.div,{variants:ye,initial:"hidden",animate:"visible",children:n}),h=({children:n})=>e(p.div,{variants:xe,children:n}),ke=()=>i(we,{children:[e(be,{}),e(a,{children:"Hello I am"}),e(v,{children:"Bruno Millalipe"}),e(a,{children:"- Web Developer -"}),e(y,{children:i(Ne,{children:[e(h,{children:i(I,{color:"red",children:[e("i",{className:"fas fa-envelope"}),e(a,{children:"brunomstyle@gmail.com"})]})}),e(h,{children:i(I,{color:"white",children:[e("i",{className:"fab fa-github-square"}),e(a,{children:"github.com/brunostyle"})]})}),e(h,{children:i(I,{color:"yellow",children:[e("i",{className:"fab fa-instagram"}),e(a,{children:"instagram.com/bruno.14"})]})})]})})]}),we=t.div`
  display: flex;
...
`;var Se="/assets/bruno.6799e273.jpg",Ce="/assets/cv_bruno.2d8a5c4c.pdf";const ze={hidden:{opacity:0,scale:0},visible:{opacity:1,scale:1,transition:{type:"easeInOut"}},exit:{opacity:0,scale:0,transition:{type:"easeInOut"}}},$=({children:n})=>e(p.div,{variants:ze,initial:"hidden",animate:"visible",exit:"exit",children:n}),$e=()=>e(Ie,{children:i(z,{children:[e(v,{children:"About"}),e(a,{children:"My introduction"}),e($,{children:e(Be,{children:e("img",{src:Se,alt:"bruno"})})}),e(a,{children:"I am a web developer, with extensive knowledge and years of experience, working in web technologies and UI / UX design, delivering quality work."}),i(Le,{children:[i("div",{children:[e(L,{children:"05+"}),e(a,{children:"years of experience"})]}),i("div",{children:[e(L,{children:"20+"}),e(a,{children:"finished projects"})]}),i("div",{children:[e(L,{children:"1000+"}),e(a,{children:"hours worked"})]})]}),i(Me,{href:Ce,download:"cv_bruno.pdf",children:[e("i",{className:"far fa-file-pdf"})," Download CV"]})]})}),Ie=t.div`
    text-align: center;
`,Le=t.div`
    display: flex;
    flex-wrap: wrap;
